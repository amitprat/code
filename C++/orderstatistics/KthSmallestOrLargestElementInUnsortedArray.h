    ...
    int findKthSmallestPartitioningInterval(vector<int>& v, int l, int r, int k) {
        if (l <= r) {
            ...
            if (q == k)
                ...
                return findKthSmallestPartitioningInterval(v, l, p - 1, k);
            else
                return findKthSmallestPartitioningInterval(v, p + 1, r, k - q);
        }
    }
    ...
    int findKthLargestPartitioningInterval(vector<int>& v, int l, int r, int k) {
        if (l <= r) {
            ...
            if (q == k)
                ...
                return findKthLargestPartitioningInterval(v, p + 1, r, k);
            else
                return findKthLargestPartitioningInterval(v, l, p - 1, k - q);
        }
    }
